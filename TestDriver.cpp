...
void drawHouse()
{
   ...
   shapeVec.push_back(std::make_unique<Rectangle>(11, 1, "antenna stem", 'I'));
   ...
   Canvas wall2 = shapeVec.back()->draw();
   houseCanvas.overlap(wall2, 24, 9);
   houseCanvas.overlap(wall2, 24, 45);
   ...
   shapeVec.push_back(std::make_unique<Rectangle>(1, 1, "door knob", 'O'));
   Canvas door_knob = shapeVec.back()->draw();
   houseCanvas.overlap(door_knob, 33, 22);

   houseCanvas.drawString(26, 25, "2134");
   ...
   shapeVec.push_back(std::make_unique<Rectangle>(5, 3, "tree trunk", 'H'));
